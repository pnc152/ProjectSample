    ...
    <div class="large-12 twelve columns hide-for-small">
      <ul class="sf-menu">
        ...
        <li><a href="#">스터디좌석 예약</a>
        	<ul class="dropdown">
        		<li><a href="reservation.study">스터디좌석 예약하기</a></li>
    ...
    <div class="large-12 twelve columns">
      <section class="slider">
        <div class="flexslider">
          <ul class="slides">
            <li><img src="images/sh1.jpg" alt=""></li>
            <li><img src="images/sh2.jpg" alt=""></li>
            <li><img src="images/sh3.jpg" alt=""></li>
          </ul>
        </div>
      </section>
    </div>
          ...
          <div class="quick-contacts">
            ...
            <form action="#" method="post" class="quick-contact-form">
              <table>
                ...
                <tr>
                  <td><textarea  name="message" placeholder="전달사항:"></textarea></td>
                </tr>
                <tr>
